...
cfg.add_argument("--poly-bases", type=str, default='Jacobi', help="Polynomial bases")
...
class PolyPCDGCN(freerec.models.RecSysArch):
    ...
    def __init__(
        ...
        self.conv = PolyPCDConv(
            ...
            L=cfg.layers, poly_base=cfg.poly_base,
...
class CoachForPolyPCD(freerec.launcher.GenCoach):
