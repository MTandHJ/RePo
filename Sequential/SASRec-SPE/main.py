...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, embedding_dim):
        ...
        pe = torch.zeros(cfg.maxlen, embedding_dim)
        position = torch.arange(0, cfg.maxlen, dtype=torch.float).unsqueeze(1)
...
class SASRec(freerec.models.RecSysArch):
    ...
    def __init__(
        ...
        self.Position = PositionalEncoding(cfg.hidden_size)
